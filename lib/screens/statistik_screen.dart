          ...
          Row(
            children: [
              ...
              Expanded(
                child: _statBox(
                  label: 'BESTANDSQUOTE',
                  value: '${_retention.toStringAsFixed(1)}%',
                  sub: 'Ziel: 90%',
                  subColor: const Color(0xFF92400E),
                  valueFontSize: 32,
                  valueColor: const Color(0xFFE8813A),
                    ...
                    SizedBox(
                      ...
                      child: CustomPaint(
                        painter: _DonutPainter(
                          values: [
                            (_gelerntGesamt * 0.7).toDouble(),
                            (_gelerntGesamt * 0.3).toDouble(),
  ...
  Widget _toggleChip() {
    return Container(
      ...
      child: Row(
        ...
        children: [
          _chipBtn('Tag', _showTage, () => setState(() => _showTage = true)),
          _chipBtn(
            '31 T.',
            !_showTage,

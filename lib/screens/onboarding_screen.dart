...
class _OnboardingScreenState extends State<OnboardingScreen> {
              ...
              child: Row(children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(color: const Color(0xFFE8813A).withOpacity(0.3)),
                  ),
                  child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                    const Text('LF', style: TextStyle(color: Colors.white, fontSize: 13, fontWeight: FontWeight.bold)),
                    Container(width: 16, height: 2, color: const Color(0xFFE8813A)),
                  ]),
                ),
    ...
    return Expanded(
      child: Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Text(info, style: TextStyle(color: color.withOpacity(0.7), fontSize: 10, height: 1.4)),
        ]),
      ),
    );
  }
    ...
    return Column(children: [
      ...
      Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: const Color(0xFFE8813A).withOpacity(0.25), width: 1.5),
        ),
        child: Center(child: Text(page.emoji, style: const TextStyle(fontSize: 42))),
      ),
      ...
      Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: const Color(0xFFE8813A).withOpacity(0.35)),
        ),
        child: Text(page.badge, style: const TextStyle(color: Color(0xFFE8813A), fontSize: 10, fontWeight: FontWeight.w700, letterSpacing: 0.8)),
      ),
      const SizedBox(height: 28),
      Padding(
        padding: const EdgeInsets.symmetric(horizontal: 32),
        child: Text(page.title, textAlign: TextAlign.center,
            style: const TextStyle(color: Colors.white, fontSize: 30, fontWeight: FontWeight.bold, height: 1.25)),
      ),
      ...
      if (page.detail != null) ...[
        ...
        Padding(
          ...
          child: Container(
            ...
            child: Text(page.detail!, textAlign: TextAlign.left,
                style: TextStyle(color: Colors.white.withOpacity(0.65), fontSize: 13, height: 1.7)),
          ),
        ),
      ],
      if (page.isLast) ...[
  ...
  Widget _howItWorks() {
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Text('Dein Weg zur Bestnote', style: TextStyle(
            color: Colors.white.withOpacity(0.4), fontSize: 10, letterSpacing: 0.8, fontWeight: FontWeight.w600)),
        const SizedBox(height: 14),
        ...steps.map((s) => Padding(
          ...
          child: Row(children: [
            Container(
              width: 26, height: 26,
              decoration: BoxDecoration(
                color: s.$4 ? const Color(0xFF22C55E).withOpacity(0.2) : const Color(0xFFE8813A).withOpacity(0.2),
                borderRadius: BorderRadius.circular(7),
              ),
              child: Center(child: Text(s.$1, style: TextStyle(
                  color: s.$4 ? const Color(0xFF22C55E) : const Color(0xFFE8813A),
            ...
            Expanded(child: Row(
              ...
              children: [
                Text(s.$2, style: const TextStyle(color: Colors.white, fontSize: 13, fontWeight: FontWeight.w600)),
                Text(s.$3, style: TextStyle(color: Colors.white.withOpacity(0.4), fontSize: 11)),
              ],
            )),
          ]),
        )),
  ...
  void _nextPage() => _controller.nextPage(duration: const Duration(milliseconds: 350), curve: Curves.easeInOut);
  void _goToLast() => _controller.animateToPage(_pages.length - 1, duration: const Duration(milliseconds: 400), curve: Curves.easeInOut);
  void _startTrial() => Navigator.pushReplacement(context, MaterialPageRoute(builder: (_) => const FreeTrialScreen()));
}
...
class _OPage {
  ...
  final String? detail;
  final bool isLast;
  const _OPage({required this.emoji, required this.badge, required this.title, required this.subtitle, this.detail, this.isLast = false});
}
